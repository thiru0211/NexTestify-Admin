Feature: CANDIDATE
  ...
  Background: Candidate
    ...
    When To Check candidate Enter username and password are "thirumaran@sankarasoftware.com" and "Thirumaran@001"
  ...
  Scenario: Candidate:Search Check
    Given Enter valid username "Ranjith" in the searchbox in candidate page
    When Check entered username "Ranjith" is displayed or not in candidate page
