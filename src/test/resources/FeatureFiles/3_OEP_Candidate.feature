Feature: CANDIDATE
  ...
  Background: Candidate
    Given To Check candidate is navigating to OEP URL is "https://hedgeonline.in/OEPADMIN/Login"
    When To Check candidate Enter username and password are "thirumaran@sankarasoftware.com" and "Thirumaran@123"
  ...
  Scenario: Candidate:Search Check
    Given Enter valid username "Gopal samy" in the searchbox in candidate page
    When Check entered username "Gopal samy" is displayed or not in candidate page
    Then Close candidate button

  @TC_02
  Scenario: Candidate:Search Check
    Given Enter valid email id "thirumaran@sankarasoftware.com" in the searchbox in candidate page
    When Check entered emailid "thirumaran@sankarasoftware.com" is displayed or not in candidate page
    Then Close candidate button

  @TC_03
  Scenario: Candidate:Search Check
    Given Enter valid phone number "8098911086" in the searchbox in candidate page
    When Check entered phone number "+91-8098911086" is displayed or not in candidate page
    Then Close candidate button
