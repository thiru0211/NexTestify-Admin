Feature: TEST SETUP
  ...
  Background: Test Setup
    Given To Check Test Setup is navigating to OEP URL is "https://hedgeonline.in/OEPADMIN/Login"
    When To Check Test Setup Enter username and password are "thirumaran@sankarasoftware.com" and "Thirumaran@123"
    And click the Signin button To Check Test Setup
    Then Click Test Setup button

  @TC_01
  Scenario: Test Setup:Search Check
    Given Enter valid test name "For Automation Testing-1" in the searchbox
    When Check entered "For Automation Testing-1" test name details is displayed or not in the test setup page
    And Enter valid description "Test created for check the automation testing" in the searchbox
    Then Check entered "Test created for check the automation testing" description details is displayed or not in the test setup page
    Then Close Test Setup button

  @TC_02
  Scenario: Test Setup:Filter Check
    Given Select "All Status" Option in the dropdown
    When Select "In Progress" Option in the dropdown
    Then Check In Progress details displayed or not
    And Select "Completed" Option in the dropdown
    Then Check Completed details displayed or not
    And Select "Frozen" Option in the dropdown
    Then Check Frozen details displayed or not
    Then Close Test Setup button

  @TC_03
  Scenario: Test Setup:Test Type Check
    Given Select "All Test" test type Option in dropdown
    When Select "Practice Test" test type Option in dropdown
    Then Check selected "Practice Test" test type option is displayed or not
    Then Close Test Setup button

  @TC_04
  Scenario: Test Setup:Subject Check
    Given Select "All Subject" subject Option in the dropdown
    Then Close Test Setup button
  ...
  @TC_23
  Scenario: Question Manager:Valid Check
    Given Search any valid main test name
    Then Click the test name
    And Click question manager tab
    Then Enter valid overall question
  ...
  Scenario: Grading Setup:Valid Check
    ...
    And Click Grading setup tab
    Then Click clear button
    And Enter valid message in the all respondents text box
    Then Enter valid message in the all passed text box
    And Enter valid message in the all failed text box
    Then Enter valid pass mark value details
    And Select "Percentage" option in unit dropdown
    Then Select "Percentage" option in ranges unit
    And Enter valid from range value in range 1st tab
    Then Enter valid to range value in range 1st tab
    And Enter valid grade "F" in range 1st tab
    And Enter valid from range value in range 2nd tab
    Then Enter valid to range value in range 2nd tab
    And Enter valid grade "P" in range 2nd tab
  ...
  Scenario: Grading Setup:Valid Check
    ...
    And Enter valid message in the all failed text box
    Then Enter valid pass mark value details
    And Select "Points" option in unit dropdown
    Then Select "Points" option in ranges unit
    And Enter valid from range value in range 1st tab
    Then Enter valid to range value in range 1st tab
    And Enter valid grade "F" in range 1st tab
    And Enter valid from range value in range 2nd tab
  ...
  #Then Check success message is displayed or not in test access
  #Then Close Test Setup button
  #@TC_43(Due to if we Finalize the test, test change to completed status thats why i skip the test method)
