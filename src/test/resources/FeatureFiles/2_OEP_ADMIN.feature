Feature: ADMIN
  ...
  Background: Admin
    Given To Check Admin is navigating to OEP URL is "https://hedgeonline.in/OEPADMIN/Login"
  ...
  Scenario: Update Admin:Valid Check
    Given Enter user name "0211thiru@gmail.com" in the Search box
   ...
   @TC_40
  Scenario: Update Admin:Valid Check
    Given Enter user name "Developer Sankara" in the Search box
    When Click Edit button
    Then Change the status to inactive mode
    And Click update button in edit admin page
    Then Check admin user updated success message is displayed or not
    And Select "All" Option in status dropdown
    Then Enter user name "Developer Sankara" in the Search box
  ...
  Scenario: Update Admin:Valid Check
   ...
   @TC_42
  Scenario: Update Admin:Valid Check
    Given Enter user name "developersankara@gmail.com" in the Search box
    When Click Edit button
