...
//		option.addArguments("--headless=new");
	...
	public void click_candidate_button_in_admin_module() throws InterruptedException {
		...
		ele1.click();
		Thread.sleep(2000);
		wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//span[normalize-space(text())='Candidate']")));
		ele2 = driver.findElement(By.xpath("//span[normalize-space(text())='Candidate']"));
		ele2.click();
