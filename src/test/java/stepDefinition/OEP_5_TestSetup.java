...
//		option.addArguments("--headless=new");
	...
	public void click_test_setup_button() {
		...
		By collapseToggle = By.xpath("(//a[@data-bs-toggle='collapse'])[4]");
		...
		By labelSpan = By.xpath("(//a[@data-bs-toggle='collapse'])[4]");
	...
	@Given("Select {string} Option in the dropdown")
	public void select_1st_option_in_the_dropdown(String status) {
		// Always reuse one WebDriverWait object
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));

		// Step 1: Wait for page DOM ready
		...
		// Step 3: Now wait until the dropdown is clickable
		WebElement ele1 = wait.until(ExpectedConditions.elementToBeClickable(
				By.xpath("(//div[@class='react-select__single-value css-1uccc91-singleValue'])[1]")));

		// Step 4: Click dropdown
		ele1.click();

		// Step 5: Wait until "All Status" option is visible and clickable
		WebElement ele2 = wait.until(
				ExpectedConditions.elementToBeClickable(By.xpath("//div[normalize-space(text())='" + status + "']")));
	...
	@Given("Select {string} test type Option in dropdown")
	public void select_test_type_option_in_dropdown(String testType) throws InterruptedException {
		Thread.sleep(10000);
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
		wait.until(webDriver -> ((JavascriptExecutor) webDriver).executeScript("return document.readyState")
				.equals("complete"));
		wait.until(ExpectedConditions.invisibilityOfElementLocated(By.cssSelector("div.loaderStyle")));
		By testDropdown = By.xpath(
		...
		WebElement dropdown = driver.findElement(testDropdown);
		dropdown.click();
		Thread.sleep(2000);
		WebElement optionSelect = driver.findElement(By.xpath("//div[normalize-space(text())='" + testType + "']"));
		optionSelect.click();
	}
	...
	@When("Select {string} subject Option in the dropdown")
	public void select_subject_option_in_the_dropdown(String subject) throws InterruptedException {
		Thread.sleep(4000);
		wait = new WebDriverWait(driver, Duration.ofSeconds(30));
		wait.until(ExpectedConditions.elementToBeClickable(
				By.xpath("(//div[@class='react-select__single-value css-1uccc91-singleValue'])[3]")));
		ele1 = driver.findElement(By.xpath("(//div[@class='react-select__single-value css-1uccc91-singleValue'])[3]"));
		ele1.click();
		Thread.sleep(2000);
		ele2 = driver.findElement(By.xpath("//div[normalize-space(text())='" + subject + "']"));
		Thread.sleep(2000);
		ele2.click();
	}
	...
	@Then("Check selected {string} test type option is displayed or not")
	public void check_selected_test_type_option_is_displayed_or_not(String option) throws InterruptedException {
		Thread.sleep(3000);
		wait = new WebDriverWait(driver, Duration.ofSeconds(30));
...
//		Assert.assertEquals("Page displayed invalid details", actualDescription, expectedDescription);\
	...
	public void click_new_test_button() {
		...
		// Step 3: Wait for button visible
		...
		((JavascriptExecutor) driver).executeScript("arguments[0].scrollIntoView({block: 'center'});", ele1);

		// Step 5: Ensure not covered
		wait.until(ExpectedConditions.elementToBeClickable(ele1));

		// Step 6: Try safe click
		try {
			ele1.click();
...
//		Assert.assertEquals("Page doesnot landed to test setup homepage", actualUrl, expectedUrl);
	...
	public void click_main_test_radio_button() {
		...
		// Step 1: Ensure DOM is fully loaded
		wait.until(webDriver -> ((JavascriptExecutor) webDriver).executeScript("return document.readyState")
				.equals("complete"));

		// Step 2: Ensure loader not visible
		wait.until(ExpectedConditions.invisibilityOfElementLocated(By.cssSelector("div.loaderStyle")));

		// Step 3: Wait until radio button is visible
		WebElement ele1 = wait
				.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//input[@name='ttype'])[2]")));

		// Step 4: Scroll into view
		((JavascriptExecutor) driver).executeScript("arguments[0].scrollIntoView({block:'center'});", ele1);

		// Step 5: Wait again until loader disappears (covering edge case of reappearing
		// loader)
		wait.until(ExpectedConditions.invisibilityOfElementLocated(By.cssSelector("div.loaderStyle")));

		// Step 6: Ensure clickable
		wait.until(ExpectedConditions.elementToBeClickable(ele1));
...
//		String firstName = fakename.name().
	...
	public void select_valid_subject_name() throws InterruptedException {
		...
		dropdown.click();
		Thread.sleep(2000);
		WebElement optionSelect = driver
				.findElement(By.xpath("//div[normalize-space(text())='Artificial Intelligence']"));
		optionSelect.click();
	}
	...
	public void click_clear_button() throws InterruptedException {
		Thread.sleep(2000);
		wait = new WebDriverWait(driver, Duration.ofSeconds(30));
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//button[contains(.,'Clear')]")));
	...
	public void search_any_valid_main_test_name() throws InterruptedException {
		...
		// Step 6: Clear & type text character by character (after page is ready)
		ele1.clear();
		String textToType = "Test_";
		for (char c : textToType.toCharArray()) {
			ele1.sendKeys(String.valueOf(c));
			Thread.sleep(200); // delay between keystrokes
		}
	}

	@Then("Click the test name")
	public void click_the_test_name() {
		By testCard = By.xpath("(//div[@class='hover-border-primary card-body'])[1]");

		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));

		// Wait until clickable
		WebElement ele1 = wait.until(ExpectedConditions.elementToBeClickable(testCard));

		// Safe click using JS to avoid stale interception
		((JavascriptExecutor) driver).executeScript("arguments[0].click();", ele1);
	...
	public void click_add_button() {
		...
		ele1 = driver.findElement(By.xpath("//button[contains(.,'Add')]"));
		ele1.click();
	}
	...
	public void check_red_border_is_displayed_or_not_in_the_mandatory_tab() throws InterruptedException {
		...
		String expectedBorderColor = "rgb(255, 0, 0)";
		System.out.println("ℹ️ Actual border color : " + borderColor);
	...
	public void click_no_button_in_the_pop_up() {
		wait = new WebDriverWait(driver, Duration.ofSeconds(30));
		wait.until(ExpectedConditions
				.elementToBeClickable(By.xpath("(//button[contains(@class,'btn btn-outline-primary')])[3]")));
	...
	public void enter_the_value_in_questions_tab_more_than_overall_questions_tab() throws InterruptedException {
		...
		// ✅ Step 2 (optional): Wait for any loader/spinner to disappear
		wait.until(ExpectedConditions.invisibilityOfElementLocated(By.cssSelector("div.loaderStyle")));

		WebElement ele1 = wait.until(ExpectedConditions.presenceOfElementLocated(By.id("tquest-2")));
		wait.until(ExpectedConditions.visibilityOf(ele1));

		// ✅ Step 4: Scroll into view (center to avoid overlaps)
		((JavascriptExecutor) driver).executeScript("arguments[0].scrollIntoView({block:'center'});", ele1);

		// ✅ Step 5: Wait until element is clickable
		wait.until(ExpectedConditions.elementToBeClickable(ele1));

		// ✅ Step 6: Perform actions safely
		ele1.click();
		Thread.sleep(1000); // avoid race conditions if UI is slow
		ele1.clear();
		Thread.sleep(1000);
		ele1.sendKeys("20");
	...
	public void click_save_button_in_question_manager() {
		...
		ele1 = driver.findElement(By.xpath("//button[@class='btn btn-sm btn-primary']"));
		ele1.click();
	}
	...
	public void click_save_button_in_time_setup() throws InterruptedException {
		...
		ele1 = driver.findElement(By.xpath("//button[contains(.,'Save')]"));
		JavascriptExecutor js = (JavascriptExecutor) driver;
		js.executeScript("arguments[0].scrollIntoView(true);", ele1);
		Thread.sleep(3000);
		ele1.click();
	...
	public void click_grading_setup_tab() {
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
		...
		// Step 3: Wait until button is visible
		WebElement ele1 = wait
				.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//button[text()='Grading Setup']")));

		// Step 4: Scroll into view (center)
		((JavascriptExecutor) driver).executeScript("arguments[0].scrollIntoView({block:'center'});", ele1);

		// Step 5: Ensure clickable
		wait.until(ExpectedConditions.elementToBeClickable(ele1));
	...
	public void enter_valid_message_in_the_all_respondents_text_box() {
		wait = new WebDriverWait(driver, Duration.ofSeconds(30));
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//div[@class='jodit-wysiwyg'])[1]")));
	...
	public void enter_valid_message_in_the_all_passed_text_box() {
		wait = new WebDriverWait(driver, Duration.ofSeconds(30));
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//div[@class='jodit-wysiwyg'])[2]")));
	...
	public void enter_valid_message_in_the_all_failed_text_box() {
		wait = new WebDriverWait(driver, Duration.ofSeconds(30));
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//div[@class='jodit-wysiwyg'])[3]")));
		ele1 = driver.findElement(By.xpath("(//div[@class='jodit-wysiwyg'])[3]"));
	...
	public void check_tab_is_empty_or_not_in_pass_mark_tab() {
		...
		if (containsOnlyNumbers) {
			System.out.println("ℹ️ Tab contains only numbers.");
		} else {
			System.out.println("ℹ️ Tab contains alphabetic or special characters.");
		}
	...
	public void click_add_range_button() throws InterruptedException {
		wait = new WebDriverWait(driver, Duration.ofSeconds(30));
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//button[contains(.,'Add Range')]")));
		ele1 = driver.findElement(By.xpath("//button[contains(.,'Add Range')]"));
		JavascriptExecutor js = (JavascriptExecutor) driver;
		js.executeScript("arguments[0].scrollIntoView(true);", ele1);
		Thread.sleep(2000);
		ele1.click();
	...
	public void check_all_tab_is_cleared_or_not_in_grading_setup() throws InterruptedException {
		...
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//div[@class='jodit-wysiwyg'])[2]")));
		ele2 = driver.findElement(By.xpath("(//div[@class='jodit-wysiwyg'])[2]"));
		String passedMessage = ele2.getText();

		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//div[@class='jodit-wysiwyg'])[3]")));
		ele3 = driver.findElement(By.xpath("(//div[@class='jodit-wysiwyg'])[3]"));
	...
	@Then("Select {string} option in unit dropdown")
	public void select_1st_option_in_unit_dropdown(String options) throws InterruptedException {
		Thread.sleep(2000);
		wait = new WebDriverWait(driver, Duration.ofSeconds(30));
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath(
				"(//div[contains(@class,'react-select__value-container react-select__value-container--has-value')])[1]")));
		...
		ele1.click();
		Thread.sleep(2000);
		ele2 = driver.findElement(By.xpath("//div[normalize-space(text())='" + options + "']"));
		ele2.click();
	}

	@Then("Select {string} option in ranges unit")
	public void select_1st_option_in_ranges_unit(String options) throws InterruptedException {
		Thread.sleep(2000);
		wait = new WebDriverWait(driver, Duration.ofSeconds(30));
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath(
				"(//div[contains(@class,'react-select__value-container react-select__value-container--has-value')])[2]")));
	...
	public void unselect_the_selected_checkbox_in_all_tabs() throws InterruptedException {
		wait = new WebDriverWait(driver, Duration.ofSeconds(30));
		wait.until(ExpectedConditions
				.elementToBeClickable(By.xpath("(//input[contains(@class,'form-check-input mt-2p')])[1]")));
		ele1 = driver.findElement(By.xpath("(//input[contains(@class,'form-check-input mt-2p')])[1]"));
		ele2 = driver.findElement(By.xpath("(//input[contains(@class,'form-check-input mt-2p')])[2]"));
		ele3 = driver.findElement(By.xpath("(//input[contains(@class,'form-check-input mt-2p')])[3]"));
		ele4 = driver.findElement(By.xpath("(//input[contains(@class,'form-check-input mt-2p')])[4]"));
		ele5 = driver.findElement(By.xpath("(//input[contains(@class,'form-check-input mt-2p')])[5]"));
		ele6 = driver.findElement(By.xpath("(//input[contains(@class,'form-check-input mt-2p')])[6]"));
		ele7 = driver.findElement(By.xpath("(//input[contains(@class,'form-check-input mt-2p')])[7]"));
		ele8 = driver.findElement(By.xpath("(//input[contains(@class,'form-check-input mt-2p')])[8]"));
		ele9 = driver.findElement(By.xpath("(//input[contains(@class,'form-check-input mt-2p')])[9]"));
		WebElement ele10 = driver.findElement(By.xpath("(//input[contains(@class,'form-check-input mt-2p')])[10]"));
		WebElement ele11 = driver.findElement(By.xpath("(//input[contains(@class,'form-check-input mt-2p')])[11]"));
		if (ele1.isSelected() && ele2.isSelected() && ele3.isSelected() && ele4.isSelected() && ele5.isSelected()
				...
				&& ele10.isSelected() && ele11.isSelected()) {
			ele1.click();
			Thread.sleep(1000);
			ele2.click();
			Thread.sleep(1000);
			...
			System.out.println("ℹ️ Check box is already unselected");
		}
	}
	...
	public void check_checkbox_is_unselected_or_not() {
		...
		if (ele1.isSelected() && ele2.isSelected() && ele3.isSelected() && ele4.isSelected() && ele5.isSelected()
				&& ele6.isSelected() && ele7.isSelected() && ele8.isSelected() && ele9.isSelected()
				&& ele10.isSelected() && ele11.isSelected()) {
			System.out.println("ℹ️ Check box is selected");
		} else {
			System.out.println("ℹ️ Check box is already unselected");
		}
		...
		Assert.assertTrue("11th Checkbox cannot able to unselect", !ele11.isSelected());
	...
	public void check_checkbox_is_selected_or_not() {
		...
		Assert.assertTrue("11th Checkbox cannot able to select", ele11.isSelected());
	}
	...
	public void unselect_the_checkbox() {
		...
		if (ele1.isSelected()) {
			...
			System.out.println("ℹ️ Checkbox is already unselected");
		}
	}
	...
	public void click_finalize_button_in_Finalize_test_page() {
		wait = new WebDriverWait(driver, Duration.ofSeconds(30));
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//button[contains(.,'Finalize')])[2]")));
		ele1 = driver.findElement(By.xpath("(//button[contains(.,'Finalize')])[2]"));
		ele1.click();
	}
...
//		String firstName = fakename.name().
	...
	public void modify_the_details_in_basic_settings() throws InterruptedException {
		...
		// ✅ Step 1: Wait until page fully loaded (DOM ready)
		wait.until(webDriver -> ((JavascriptExecutor) webDriver).executeScript("return document.readyState")
				.equals("complete"));

		// ✅ Step 2: Wait until element is clickable
		wait.until(ExpectedConditions.elementToBeClickable(By.name("testName")));
		WebElement ele1 = driver.findElement(By.name("testName"));

		// ✅ Step 3: Get existing value
		String testName = ele1.getDomProperty("value");
		int length = testName.length();

		// Clear using BACK_SPACE
		Thread.sleep(2000);
		for (int i = 0; i < length; i++) {
			ele1.sendKeys(Keys.BACK_SPACE);
		}

		// ✅ Step 4: Re-enter value
		Thread.sleep(2000);
	...
	public void click_update_button_in_grading_setup() {
		wait = new WebDriverWait(driver, Duration.ofSeconds(30));
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//button[contains(.,'Update')]")));
		ele1 = driver.findElement(By.xpath("//button[contains(.,'Update')]"));
		JavascriptExecutor js = (JavascriptExecutor) driver;
		js.executeScript("arguments[0].scrollIntoView(true);", ele1);
		ele1.click();
	}
