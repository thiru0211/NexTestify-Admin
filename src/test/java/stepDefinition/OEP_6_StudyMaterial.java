...
public class OEP_6_StudyMaterial {
...
//		option.addArguments("--headless=new");
	...
	public void click_the_signin_button_to_check_study_material() {
		ele1 = driver.findElement(By.xpath("//button[contains(.,'Login')]"));
		ele1.click();
	}
	...
	public void click_Study_Material_button() {
		...
		By collapseToggle = By.xpath("(//a[@data-bs-toggle='collapse'])[6]");
		...
		By labelSpan = By.xpath("(//a[@data-bs-toggle='collapse'])[6]");
	...
	@Given("Click {string} subject name")
	public void click_subject_name(String subjName) {
		wait = new WebDriverWait(driver, Duration.ofSeconds(30));
		wait.until(ExpectedConditions
				.elementToBeClickable(By.xpath("//button[normalize-space(text())='" + subjName + "']")));

		ele1 = driver.findElement(By.xpath("//button[normalize-space(text())='" + subjName + "']"));

		// ✅ Scroll into view
		((JavascriptExecutor) driver).executeScript("arguments[0].scrollIntoView({block: 'center'});", ele1);

		// ✅ Extra: wait for any loader/overlay if exists
		wait.until(ExpectedConditions.invisibilityOfElementLocated(By.cssSelector("div.loaderStyle")));

		// ✅ Perform JS click to avoid interception
	...
	public void click_view_material_button() {
		wait = new WebDriverWait(driver, Duration.ofSeconds(30));
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//button[contains(@class,'btn btn-sm')])[2]")));
	...
	public void enter_valid_synopsis() throws InterruptedException {
		wait = new WebDriverWait(driver, Duration.ofSeconds(30));
		wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//div[@class='jodit-wysiwyg']")));
		ele1 = driver.findElement(By.xpath("//div[@class='jodit-wysiwyg']"));
		JavascriptExecutor js = (JavascriptExecutor) driver;
		js.executeScript("arguments[0].scrollIntoView(true);", ele1);
		Thread.sleep(2000);
	...
	public void check_details_are_cleared_or_not_in_add_material() throws InterruptedException {
		...
		wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//div[@class='jodit-wysiwyg']")));
		ele2 = driver.findElement(By.xpath("//div[@class='jodit-wysiwyg']"));
	...
	public void check_alert_message_is_displayed_or_not_in_add_subject_in_create_material()
		...
		String expMessage = "Subject already exists!";
	...
	public void enter_valid_subject_name_in_add_subject() {
		...
		String subjectName = faker.book().genre();
		ele1.sendKeys(subjectName);
	}

	@Then("Enter {string} subject name in add subject")
	public void enter_subject_name_in_add_subject(String subjName) {
		wait = new WebDriverWait(driver, Duration.ofSeconds(30));
		wait.until(ExpectedConditions.presenceOfElementLocated(By.id("catName")));
		ele1 = driver.findElement(By.id("catName"));
		ele1.sendKeys(subjName);
	}
	
	@When("Select {string} subject from the dropdown in the subject tab")
	public void select_subject_from_the_dropdown_in_the_subject_tab(String subjName) throws InterruptedException {
		Thread.sleep(2000);
		wait = new WebDriverWait(driver, Duration.ofSeconds(30));
		wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath(
				"(//div[contains(@class,'react-select__value-container react-select__value-container--has-value')])[1]")));
		...
		ele1.click();
		Thread.sleep(2000);
		ele2 = driver.findElement(By.xpath("//div[normalize-space(text())='"+subjName+"']"));
		ele2.click();
	}
	...
	public void click_edit_button_of_the_subject_tab() {
		wait = new WebDriverWait(driver, Duration.ofSeconds(30));
		wait.until(ExpectedConditions
				.presenceOfElementLocated(By.xpath("(//button[contains(@class,'btn btn-sm btn-outline')])[3]")));
		ele1 = driver.findElement(By.xpath("(//button[contains(@class,'btn btn-sm btn-outline')])[3]"));
		ele1.click();
	}
	...
	public void click_delete_button_of_the_subject_tab() {
		wait = new WebDriverWait(driver, Duration.ofSeconds(30));
		wait.until(ExpectedConditions
				.presenceOfElementLocated(By.xpath("(//button[@class='btn btn-sm btn-outline-primary ms-2'])[4]")));
		ele1 = driver.findElement(By.xpath("(//button[@class='btn btn-sm btn-outline-primary ms-2'])[4]"));
		ele1.click();
	}
	...
	public void click_no_button_in_the_delete_subject_popup() {
		wait = new WebDriverWait(driver, Duration.ofSeconds(30));
		wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//button[text()='No']")));
		ele1 = driver.findElement(By.xpath("//button[text()='No']"));
		ele1.click();
	}
	...
	public void click_yes_button_in_the_delete_subject_popup() {
		wait = new WebDriverWait(driver, Duration.ofSeconds(30));
		wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//button[text()='Yes']")));
		ele1 = driver.findElement(By.xpath("//button[text()='Yes']"));
		ele1.click();
	}
	...
	public void click_add_button_in_topic_tab_in_create_material_page() {
		wait = new WebDriverWait(driver, Duration.ofSeconds(30));
		wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("(//button[@class='btn btn-sm btn-outline-primary ms-2'])[5]")));
	...
	public void click_add_button_in_add_topic_tab() {
		wait = new WebDriverWait(driver, Duration.ofSeconds(30));
		wait.until(
				ExpectedConditions.presenceOfElementLocated(By.xpath("(//button[contains(@class,'btn btn-outline-primary')])[2]")));
		ele1 = driver.findElement(By.xpath("(//button[contains(@class,'btn btn-outline-primary')])[2]"));
		ele1.click();
	}
	...
	public void select_any_topic_name_from_the_dropdown_in_the_topic_tab() throws InterruptedException {
		...
		ele1.click();
		Thread.sleep(2000);
		ele2 = driver.findElement(By.xpath("//div[normalize-space(text())='Sample Test']"));
		ele2.click();
	}
	...
	public void click_edit_button_in_topic_tab_in_create_material_page() {
		wait = new WebDriverWait(driver, Duration.ofSeconds(30));
		wait.until(
				ExpectedConditions.presenceOfElementLocated(By.xpath("(//button[@class='btn btn-sm btn-outline-primary ms-2'])[6]")));
		ele1 = driver.findElement(By.xpath("(//button[@class='btn btn-sm btn-outline-primary ms-2'])[6]"));
		ele1.click();
	}
	...
	public void click_delete_button_in_topic_tab() {
		wait = new WebDriverWait(driver, Duration.ofSeconds(30));
		wait.until(
				ExpectedConditions.presenceOfElementLocated(By.xpath("(//button[@class='btn btn-sm btn-outline-primary ms-2'])[7]")));
		ele1 = driver.findElement(By.xpath("(//button[@class='btn btn-sm btn-outline-primary ms-2'])[7]"));
		ele1.click();
	}
	...
	public void click_no_button_in_delete_topic() {
		wait = new WebDriverWait(driver, Duration.ofSeconds(30));
		wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("(//button[contains(@class,'btn btn-outline-primary')])[2]")));
		ele1 = driver.findElement(By.xpath("(//button[contains(@class,'btn btn-outline-primary')])[2]"));
		ele1.click();
	}
	...
	@Then("Upload valid files in reference tab")
	public void upload_valid_files_in_reference_tab() throws InterruptedException, AWTException {
		wait = new WebDriverWait(driver, Duration.ofSeconds(30));
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//label[@class='dzu-inputLabel']")));
		ele1 = driver.findElement(By.xpath("//label[@class='dzu-inputLabel']"));
		JavascriptExecutor js = (JavascriptExecutor) driver;
		js.executeScript("arguments[0].scrollIntoView(true);", ele1);
		Thread.sleep(2000);
		ele1.click();
	...
	@Then("Check files are uploaded or not in reference tab")
	public void check_files_are_uploaded_or_not_in_reference_tab() throws InterruptedException {
		wait = new WebDriverWait(driver, Duration.ofSeconds(30));
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//p[contains(@class,'mb-1 pe-2')]")));
		ele1 = driver.findElement(By.xpath("//p[contains(@class,'mb-1 pe-2')]"));
		JavascriptExecutor js = (JavascriptExecutor) driver;
		js.executeScript("arguments[0].scrollIntoView(true);", ele1);
		Thread.sleep(2000);
		Assert.assertTrue("✅ File is not uploaded!", ele1.isDisplayed());
	}
	...
	@Then("Check success message is displayed or not in create material")
	public void Check_success_message_is_displayed_or_not_in_create_material() throws InterruptedException {
		Thread.sleep(1500);
		wait = new WebDriverWait(driver, Duration.ofSeconds(30));
		wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//div[@class='Toastify__toast-body']")));
		ele1 = driver.findElement(By.xpath("//div[@class='Toastify__toast-body']"));
		String actMsg = ele1.getText();
		System.out.println("Success message displayed like: " + actMsg);
		String expMsg = "Subject added successfully!";
		Assert.assertEquals("Success message is not displayed", actMsg, expMsg);
	}
	...
	public void click_the_exercise_button() {
		wait = new WebDriverWait(driver, Duration.ofSeconds(30));
		wait.until(ExpectedConditions
				.presenceOfElementLocated(By.xpath("(//button[contains(@class,'btn btn-sm')])[2]")));
		ele1 = driver.findElement(By.xpath("(//button[contains(@class,'btn btn-sm')])[2]"));
		ele1.click();
	}
