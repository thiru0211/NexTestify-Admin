Feature: REPORTS
  ...
  Background: Reports
    Given To Check Reports is navigating to OEP URL is "https://hedgeonline.in/OEPADMIN/Login"
    When To Check Reports Enter username and password are "thirumaran@sankarasoftware.com" and "Thirumaran@123"
  ...
  Scenario: Test Results:Calendar Check
    ...
    When Select valid from date "12/01/2024" in test results page
    Then Select valid to date "12/31/2030" in test results page
  ...
  Scenario: Test Results:Level Check
    Given Click Test Results button
    When Select valid from date "12/01/2024" in test results page
    And Select valid to date "12/31/2030" in test results page
  ...
  Scenario: Event Log:Calendar Check
    ...
    When Select valid from date "12/01/2024" in Event Log page
    Then Select valid to date "12/31/2030" in Event Log page
  ...
  Scenario: Event Log:Search Check
    Given Click Event Log button
    When Enter valid IpAddress "106.195.42.82" in event log page
    And Check IpAddress "106.195.42.82" details are displayed or not in Event Log page
    Then Close Reports page
